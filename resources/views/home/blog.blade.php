<div id="blog" class="container-fluid bg-dark text-light py-5 text-center wow fadeIn">
    <h2 class="section-title py-5">WARJAW FOODS & DRINKS</h2>
            ...
            @foreach ($data as $data)
                ...
                <div class="col-md-4">
                    <div class="card bg-transparent border my-3 my-md-0">
                        ...
                        <div class="card-body">
                            <h1 class="text-center mb-4"><a class="badge badge-primary">{{ $data->price }}</a>
                            </h1>
                    ...
                    <form action="{{ url('add_cart',$data->id) }}" method="post">
                        ...
                        <input class="mb-2 btn btn-info" type="submit" value="Masukkan Keranjang">
